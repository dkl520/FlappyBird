...
# ==========================================
MODELS_DIR = "models/flappy_ppo_hardv9"  # 模型保存目录（区别于普通版本）
LOG_DIR = "logs/flappy_ppo_hardv9"       # TensorBoard 日志目录
BEST_MODEL_NAME = "best_modelv9"         # 最佳模型文件名（自动保存）
FINAL_MODEL_NAME = "last_run_modelv9"    # 最终模型文件名（每次训练结束保存）
...
def make_env():
    ...
    env = StrictSafetyWrapper(env, safe_dist=0.16)
